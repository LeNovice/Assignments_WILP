...
def calculate_Greedy(heap, K):
    ...
    f = open("sample_data/outputPS11.txt", "a")
...
if __name__ == "__main__":
    global unlimited_boxes
    inputlines = read_input("sample_data/inputPS11.txt")
    num_testcases = int(inputlines[0])
    data_lines = inputlines[1:]
    for i in range(0,len(data_lines),2):
        print("---------------TestCase_" + str(i) + "---------------")
